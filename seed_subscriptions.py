...
def seed_subscriptions():
    ...
    try:
        ...
        subscriptions = [
            Subscription(name="Starter", price="$89.99/month", credits=100),
            Subscription(name="Pro", price="$199.99/month", credits=300),
            Subscription(name="Elite", price="$499.99/month", credits=1000),
        ]
        ...
        for sub in subscriptions:
            print(f"  - {sub.name}: {sub.price} ({sub.credits} credits)")
